...
class ChildEnrollmentDetailsModel {
  String? childName;
  int? enrollmentCount;
  List<ChildEnrollments>? enrollments;

  ChildEnrollmentDetailsModel(
      {this.childName, this.enrollmentCount, this.enrollments});

  ChildEnrollmentDetailsModel.fromJson(json) {
    childName = json['child_name'];
    enrollmentCount = json['enrollment_count'];
    if (json['enrollments'] != null) {
      enrollments = <ChildEnrollments>[];
      json['enrollments'].forEach((v) {
        enrollments!.add(new ChildEnrollments.fromJson(v));
      });
    }
  }
...
class ChildEnrollments {
  ...
  ChildEnrollments.fromJson(Map<String, dynamic> json) {
    id = json['id'];
