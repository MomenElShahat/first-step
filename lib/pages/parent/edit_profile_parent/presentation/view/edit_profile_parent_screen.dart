...
import '../controller/edit_profile_parent_controller.dart';

class EditProfileParentScreen extends GetView<EditProfileParentController> {
  const EditProfileParentScreen({super.key});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  buildEditableField(
                                    ...
                                    controllerField: controller.nationalNumber,
                                    hint: AppStrings.egWowNursery,
                                    maxLength: 10,
                                    validator: (val) =>
                                    controller.nationalNumber.text.isNotEmpty
                                        ? null
                                        : AppStrings.emptyField,
                                    focusNode: controller.nationalNumberFocus,
                                  ),
                                  // Save / Cancel buttons
                                  Gaps.vGap24,
                                  Obx(() {
                                          ...
                                          Expanded(
                                            child: CustomButtonContainer(
                                              CustomButton(
                                                ...
                                                onPressed: () {
                                                  controller.getData(controller.showParentDataModel!);
