...
import '../../../add_child/presentation/widgets/signup_branches_dropdown.dart';
import '../../../add_child/presentation/widgets/signup_pricing_types_dropdown.dart';

class SubDialog extends GetView<SignupParentController> {
                ...
                if (controller.isChildrenLoading.value) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Gaps.vGap16,
                      (controller.children?.isNotEmpty ?? false)
                          ? SizedBox(
                        height: 200.h,
                      ...
                      if (controller.children?.isNotEmpty ?? false) ...[
                        GetBuilder<SignupParentController>(
                          builder: (controller) {
                            return SizedBox(
                              width: double.infinity,
                      ...
                      if (controller.children?.isEmpty ?? false)
                        Center(
                          child: CustomText(
                            AppStrings.youDontHaveChildren,
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.symmetric(
                                    vertical: 10.5, horizontal: 16),
                                child: Row(
                                  mainAxisAlignment:
                                  MainAxisAlignment.center,
                                  children: [
                                    AppSVGAssets.getWidget(
                                        AppSVGAssets.plusFill,
