...
class ChildReservationCard extends StatelessWidget {
  final ChildModel childModel;
  final void Function()? onTap;

  const ChildReservationCard({super.key, required this.childModel, this.onTap});
          ...
          Row(
                  children: [
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          Get.toNamed(Routes.CHILD_RESERVATIONS_SCREEN,
                              arguments: childModel.id);
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8.r),
