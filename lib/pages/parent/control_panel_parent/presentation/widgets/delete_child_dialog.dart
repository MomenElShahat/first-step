...
Future<void> showDeleteChildConfirmDialog({
      ...
      return AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Gaps.hGap8,
            CustomText(AppStrings.deleteChild, textStyle: TextStyles.body16Medium),
          ],
        ),
        content: CustomText(AppStrings.deleteChildWarning, textStyle: TextStyles.body16Medium),
