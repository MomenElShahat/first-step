class CenterPortfolioModel {
  Data? data;

  CenterPortfolioModel({this.data});

  CenterPortfolioModel.fromJson(json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    heroSection = json['hero_section'] != null
        ? new HeroSection.fromJson(json['hero_section'])
        : null;
    ...
    philosophyMethodologyGoal = json['Philosophy_Methodology_Goal'] != null
        ?  new PhilosophyMethodologyGoal.fromJson(
            json['Philosophy_Methodology_Goal'])
        : null;
    ...
    nurseryState = json['nursery_state'] != null
        ? new NurseryState.fromJson(json['nursery_state'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.philosophyMethodologyGoal != null) {
      data['Philosophy_Methodology_Goal'] =
          this.philosophyMethodologyGoal!.toJson();
    }
...
class PhilosophyMethodologyGoal {
  ...
  PhilosophyMethodologyGoal.fromJson(Map<String, dynamic> json) {
    philosophy = json['philosophy'] != null
        ? new Philosophy.fromJson(json['philosophy'])
        : null;
    methodology = json['methodology'] != null
        ? new Philosophy.fromJson(json['methodology'])
        : null;
    goals =
        json['goals'] != null ? new Philosophy.fromJson(json['goals']) : null;
  }
