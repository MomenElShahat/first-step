...
abstract class IControlPanelRepository {
  ...
  Future<Response<PortfolioResponseModel>> updatePortfolio(
      {String? centerId, required FormData formData, required bool isUpdate});
...
class ControlPanelRepository extends BaseRepository
    implements IControlPanelRepository {
  ...
  Future<Response<String>> createPortfolioPrices({
    ...
    final apiResponse = await provider.createPortfolioPrices(
        branchIds: branchIds, portfolioPrice: portfolioPrice);
    print(apiResponse.bodyString);
    if (apiResponse.isOk &&
            apiResponse.body != null &&
            (apiResponse.statusCode == 200) ||
  ...
  Future<Response<PortfolioResponseModel>> updatePortfolio(
    ...
    final apiResponse = await provider.updatePortfolio(
        formData: formData, centerId: centerId, isUpdate: isUpdate);
    print(apiResponse.bodyString);
    if (apiResponse.isOk &&
            apiResponse.body != null &&
            (apiResponse.statusCode == 200) ||
  ...
  @override
  Future<Response<EnrollmentData>> enrollmentRespond(
      {required String enrollmentId, required String respond}) async {
    final apiResponse = await provider.enrollmentRespond(
        enrollmentId: enrollmentId, respond: respond);
    print(apiResponse.bodyString);
    if (apiResponse.isOk &&
            apiResponse.body != null &&
            (apiResponse.statusCode == 200) ||
  ...
  @override
  Future<Response<String>> deletePrice(String priceId) async {
    final apiResponse = await provider.deletePrice(priceId);
    print(apiResponse.bodyString);
    if (apiResponse.isOk &&
            apiResponse.body != null &&
            (apiResponse.statusCode == 200) ||
  ...
  Future<Response<CenterNotifyParentsResponseModel>> notifyParents({
    ...
    final apiResponse = await provider.notifyParents(body: body);
    print(apiResponse.bodyString);
    if (apiResponse.isOk &&
            apiResponse.body != null &&
            (apiResponse.statusCode == 200) ||
  ...
  Future<Response<String>> sendNotificationExpired({
    ...
    final apiResponse = await provider.sendNotificationExpired(
