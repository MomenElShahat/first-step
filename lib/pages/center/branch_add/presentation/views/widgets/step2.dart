...
class BranchAddStep2 extends GetView<BranchAddScreenController> {
  const BranchAddStep2({super.key});
...
Widget _buildCheckBoxRow(int index1, int index2, int index3, List<RxBool> isChecked) {
  return Row(
    ...
    children: [
      ...
      Gaps.hGap4,
      CheckBoxBranch(isChecked[1], label: AppStrings.from3To6Years, index: index2),
      Gaps.hGap4,
      CheckBoxBranch(isChecked[2], label: AppStrings.childrenWithSpecialNeeds, index: index3),
    ],
  );
}
