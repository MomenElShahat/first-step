...
class RadioButtonBranchEdit extends GetView<BranchEditScreenController> {
  final String label;
  final String value;
  final RxString selectedValue;

  const RadioButtonBranchEdit({super.key, required this.label, required this.value,required this.selectedValue});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BranchEditScreenController>(builder: (controller) {
      return Row(
        children: [
          InkWell(
            onTap: () {
