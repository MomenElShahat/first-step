...
import 'package:first_step/pages/center/branch_edit/presentation/views/widgets/radio_button_branch.dart';
...
class BranchEditStep3 extends GetView<BranchEditScreenController> {
  const BranchEditStep3({super.key});
...
Widget buildCheckBoxRow(int? index1, int? index2, List<RxBool> isChecked) {
  return Row(
    ...
    children: [
      ...
      Gaps.hGap4,
      if (index2 != null)
        CheckBoxBranchEdit(isChecked[1],
