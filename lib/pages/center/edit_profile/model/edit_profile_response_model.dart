class EditProfileResponseModel {
  ...
  EditProfileResponseModel({this.message, this.cityName, this.center});

  EditProfileResponseModel.fromJson(json) {
...
class Pricing {
  ...
  Pricing({this.branchId, this.enrollmentType, this.services, this.priceAmount});
