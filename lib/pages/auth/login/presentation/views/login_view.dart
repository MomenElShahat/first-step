            ...
            child: Row(
              children: [
                Expanded(
                  child: CustomButton(
                      decoration:
                          BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.white, border: Border.all(color: ColorCode.neutral400)),
                      child: CustomText(
                ...
                Expanded(
                  child: CustomButton(
                      decoration:
                          BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.white, border: Border.all(color: ColorCode.primary600)),
                      child: CustomText(
